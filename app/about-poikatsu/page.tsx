        ...
        <section className="mt-6 rounded-[2rem] bg-white p-6 shadow-lg ring-1 ring-pink-100 lg:p-8">
          ...
          <div className="flex flex-col items-center gap-6 lg:flex-row lg:justify-between">
            {[
              ...
              <div
                key={title}
                className="flex w-full items-center gap-5 lg:w-auto"
              >
                <div className="relative w-full rounded-[2rem] bg-white p-6 text-center shadow-xl ring-1 ring-pink-100 lg:w-[240px]">
                  <div className="absolute left-5 top-5 flex h-12 w-12 items-center justify-center rounded-full bg-gradient-to-br from-pink-500 to-orange-400 text-2xl font-black text-white shadow-lg">
                    {num}
                  </div>

                  <div className="mx-auto mt-8 flex h-32 w-32 items-center justify-center rounded-[2rem] bg-gradient-to-br from-pink-50 via-white to-orange-50 text-7xl shadow-md ring-1 ring-pink-100">
                    {icon}
                  </div>
                  ...
                  <p className="mt-4 min-h-[56px] text-base font-bold leading-7 text-slate-600">
                    {text}
                  </p>

                  <div className="mx-auto mt-5 h-2 w-24 rounded-full bg-gradient-to-r from-pink-500 to-orange-400" />
                </div>

                {index !== 3 && (
                  <div className="hidden h-14 w-14 shrink-0 items-center justify-center rounded-full bg-gradient-to-br from-pink-500 to-orange-400 text-3xl font-black text-white shadow-lg lg:flex">
                    →
                  </div>
                )}
              </div>
