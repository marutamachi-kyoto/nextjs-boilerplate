...
(() => {
  ...
  const ensureOfferLikeStyle = () => {
    ...
    style.textContent = [
      '.offer-like-button { display: inline-flex; min-height: 44px; width: 100%; max-width: 260px; align-items: center; justify-content: center; gap: 0.45rem; border-radius: 999px; border: 2px solid #f9a8d4; background: #fff; color: #db2777; font-weight: 950; box-shadow: 0 10px 24px rgba(236, 72, 153, 0.14); transition: transform 0.15s ease, background 0.15s ease; }',
